...
<div class="header">
    <div class="header-content">
        ...
        <a href="#" id="signIn" onclick="showWindow()">Sign in</a>
...
<div class="container">
    ...
    <% for (Player player : players) {
        out.println("<a class = \"players\" href=\"playerprofile?playername=" +player.getName() + "&" +
                        "playernumber=" + player.getNumber() +"\">"  + player.getName());
